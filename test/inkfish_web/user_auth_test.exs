defmodule InkfishWeb.UserAuthTest do
  use InkfishWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Inkfish.Users
  alias InkfishWeb.UserAuth
  import Inkfish.UsersFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, InkfishWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      InkfishWeb.Endpoint.subscribe(live_socket_id)

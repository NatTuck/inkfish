defmodule InkfishWeb.CourseControllerTest do
  ...
  describe "show course" do
    ...
    test "shows correct bucket total for student with multiple submissions", %{conn: conn} do
  ...
  defp create_course_with_assignments_and_submissions(_) do
    ...
    gcol1 = insert(:grade_column, 
      assignment: assignment1, 
      points: Decimal.new("25.0")
    )
    
    gcol2 = insert(:grade_column, 
    ...
    sub1 = insert(:sub, 
      ...
      team: team,
      active: true,
      score: Decimal.new("20.0")  # 80% of 25
    )
    ...
    sub2 = insert(:sub, 
      ...
      team: team,
      active: true,
      score: Decimal.new("25.0")  # 100% of 25
    )
